...
export const TelegramConnectCard: React.FC<TelegramCardProps> = ({
  ...
  const botUsername = process.env.NEXT_PUBLIC_TELEGRAM_BOT_USERNAME || 'SehatakReminderBot';
    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          {telegramChatId && (
            <span className="inline-flex items-center gap-1 mt-2 px-2.5 py-0.5 rounded-md bg-emerald-50 text-emerald-700 text-xs font-semibold">
      ...
      <a href={telegramDeepLink} target="_blank" rel="noopener noreferrer" className="shrink-0">
        <Button variant="secondary" className="gap-2 bg-[#0088cc] hover:bg-[#0077b3]">
